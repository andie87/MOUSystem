    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<div class="panel-body" style="padding-top: 30px;">
			<?php echo form_open_multipart('moueksekutor/uploadDokumen', array('class'=>'form-horizontal','method'=>'post'));?>
				<div class="form-group" >
					<label class="col-sm-3 control-label">Nama File</label>
					<div class="col-lg-5">
						<input type="file" name="file" style="font-size: 15px;">
						<input type="hidden" name="mou_eksekutor" value="<?php echo $id_mou_eksekutor; ?>" />
					</div>
				</div>
				<div class="form-group">
              ...
              <table id="example2" class="table table-bordered table-hover font13">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center-col">
                          <a href="<?php echo site_url('moueksekutor/moueksekutor/download/'.$d->id_dokumen_mou_eksekutor);?>">
                          <i class="fa fa-download fa-lg"></i>&nbsp;Download</a>
                        </td>
                        <td class="center-col">
                        	<a href="<?php echo site_url('moueksekutor/moueksekutor/deleteDokumen/'.$d->id_dokumen_mou_eksekutor);?>" 
